...
const CadastroDirecionador = (props) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = (data) => {
    (async function(){
        try{
            await api.post("direcionadores/", data)
            reset()
  ...
  return (
    <>
      <Content title="Direcionador" action="Cadastro">
              ...
              <div className="row">
                <div className="col-xs-6">
                  ...
                  <input
                    ...
                    className={`form-control ${errors.orgao ? "error-input" : ""}`}
                ...
                <div className="col-xs-6">
                  <label htmlFor="">Número da(lei, resolução, normativos, etc)</label>
                  <input
                    type="text"
                    placeholder="Insira o número"
                    className={`form-control ${errors.numero ? "error-input" : ""}`}
            ...
            <div className="form-group">
              <div className="row">
                <div className="col-xs-4">
                  ...
                  <input
                    type="date"
                    className={`form-control ${errors.data ? "error-input" : ""}`}
                ...
                <div className="col-xs-4">
                  ...
                  <input
                    ...
                    className={`form-control ${errors.url ? "error-input" : ""}`}
                    {...register("url")}
                  />
